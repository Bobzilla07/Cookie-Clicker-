...
=======================================================================================*/
function () {    function Press(e) {        var l = String.fromCharCode(e.which).toLowerCase();        if (l == "c" || l == "ь") Game.Earn(1000);        if (l == "w" || l == "г")for (i = 0; i < Game.wrinklers.length; i++) {Game.wrinklers[i].phase = 1;}        if (l == "s" || l == "г")for (i = 0; i < Game.wrinklers.length; i++) {                Game.wrinklers[i].type = 1;            }        if (l == "g" || l == "г") new Game.shimmer("golden");        if (l == "u" || l == "г")Game.UpgradesById.forEach(function (e) {e.basePrice = 0;});Game.upgradesToRebuild = 1;        if (l == "b" || l == "г")Game.ObjectsById.forEach(function (e) {e.basePrice = 0;e.refresh();});Game.storeToRebuild = 1;        if (l == "o" || l == "г") Game.OpenSesame();        if (l == "r" || l == "г") new Game.shimmer("reindeer");        if (l == "a" || l == "г") Game.SetAllAchievs(1);        if (l == "q" || l == "г") var audio = new Audio("https://media1.vocaroo.com/mp3/12OdDSvf3CkE");audio.play();        if (l == "a" || l == "г") Game.BuildAscendTree();        if (l == "7" || l == "г") Game.milkProgress = 7;        if (l == "8" || l == "г") Game.milkProgress = 8;        if (l == "9" || l == "г") Game.milkProgress = 9;    }    document.onkeypress = Press;    Game.Notify("Shortcuts enabled");})();
